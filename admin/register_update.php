...
<title>Everbright App</title>
      ...
      <link href="app.everbright.com.ph/libs/css/form-validation.css" rel="stylesheet" type="text/css"/>
      <!-- Bootstrap CSS -->
       ...
       <h4 class="mb-3">Access Level</h4>
        <div class="row">
           <div class="col-md-4 mb-3">
            ...
            <a href='app.everbright.com.ph/admin/users.php'><button type="button" class="btn btn-outline-secondary">Cancel</button></a>
