...
//  END HEADER    
    ...
    echo " <div> ";
    echo "           <a><button type='button' data-toggle='modal' data-target='#dealsModal' class='btn btn-outline-danger btn-sm'><i class='material-icons mdc-list-item__graphic' aria-hidden='true'>delete</i></button></a>"; 
    ...
    echo "  <p>Are you sure you want to remove all this requirements?</p>";
        ...
        echo "     <button type='button' onclick='delete_user()' class='btn btn-primary'>Remove</button>";
        echo "   </div>";
        echo "  </div>";
  echo " </div>";
  echo " </div>";
